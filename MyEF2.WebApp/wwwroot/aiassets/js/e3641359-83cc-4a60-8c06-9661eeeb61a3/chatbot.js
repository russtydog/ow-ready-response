...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // CSS file references
    var cssLinks = [
        "https://localhost:7253/aiassets/css/cb-style.css",
        "https://localhost:7253/aiassets/css/rubik.css",
        "https://localhost:7253/aiassets/css/assistant.css",
    ];
    ...
    var jsFiles = [
        "https://localhost:7253/aiassets/js/jquery-3.6.0.js",
        "https://localhost:7253/aiassets/js/bootstrap.min.js",
        "https://localhost:7253/aiassets/js/jquery-ui.js",
        "https://localhost:7253/aiassets/js/jquery.bootstrap.js",
        "https://localhost:7253/aiassets/js/jquery.min.js"
    ...
    h3.textContent = "Acme Assistant - Win10";
    h3.style.color = "#50bcce";
    ...
    typingImage.src = "https://localhost:7253/aiassets/img/typing.gif";
    ...
    sendButton.style.backgroundColor = "#50bcce";
    ...
    label.textContent = "Acme Assistant - Win10";
    ...
    function callAjaxFunction(ignoreContent) {
        ...
        $.ajax({
            url: "https://localhost:7253/AI/Chat?handler=AddMessage",
            method: "POST",
            headers: {
            ...
            success: function (startResponse) {
                ...
                var pollInterval = setInterval(function () {
                    $.ajax({
                        url: "https://localhost:7253/AI/Chat/?handler=MessageStream&MessageId=" + startResponse.messageId, // Replace with your actual URL
                        method: 'POST',
                        data: JSON.stringify({
            ...
            $(".chat-button").draggable().click(function () {
                ...
                if (historyLoded === false) {
                    if (localStorage.getItem('EFConversationId') != null) {
                        ...
                        $.ajax({
                            url: "https://localhost:7253/AI/Chat?handler=History",
                            method: "POST",
                            headers: {
                                "X-Api-Key": "your_valid_api_key"
                            },
